...
class FTRender:
    ...
    def render(self, surface):
        """Draw a simple red arrow as a render test."""
        arrow_color = (255, 0, 0)
        arrow_points = [
            (self.width // 2, self.height // 2 - 20),  # Top point
            (self.width // 2 - 20, self.height // 2 + 20),  # Bottom-left
            (self.width // 2 + 20, self.height // 2 + 20)   # Bottom-right
        ]
